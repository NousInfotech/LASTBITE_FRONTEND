...
// ✅ 1. Define prop types
interface HiddenRestaurantProps {
  restaurant: {
    id: string;
    name: string;
  };
...
// ✅ 2. Use prop types in component definition
const HiddenRestaurant: React.FC<HiddenRestaurantProps> = ({
  restaurant,
  onClose,
  onUndo,
}) => {
  ...
  const [mainModalVisible, setMainModalVisible] = useState<boolean>(true);
