...
const GeneralIssues = () => {
  ...
  const faqs = [
    {
      id: 1,
      question: "What should I do if I face issues with an order?",
      answer: "General Issues"
    },
    {
      id: 2,
      question: "How do I report an app bug or technical issue?",
      answer: "General Issues"
    },
    {
      id: 3,
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text allowFontScaling={false}  style={styles.headerTitle}>General Issues</Text>
      </View>
