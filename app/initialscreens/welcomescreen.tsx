  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.View style={{ opacity: fadeAnim }}>
        ...
        />
        <Text style={[styles.welcome, { fontFamily: 'myCustomFont' }]}>Welcome!</Text>
        ...
        <Text style={[styles.offer, { fontFamily: 'Poppins-Medium' }]}>on your first order!</Text>
      </Animated.View>
    </View>
  );
};
...
const styles = StyleSheet.create({
  ...
  discount: {
    fontSize: 19,  // Set the font size to 32px
