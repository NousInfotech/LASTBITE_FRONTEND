...
import { View, TextInput, Text, StyleSheet, Linking, Alert } from 'react-native';
...
const OTPScreen: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      <Navigation content="Enter your mobile number to get OTP" routes={{ skip: "/initialscreens/welcomescreen" }} />
      <View style={styles.content}>
        ...
        <CustomButton
          ...
          backgroundColor={mobileNumber.length === 10 && !isLoading ? '#01615F' : '#ccc'}
        />
        <View style={styles.termsAndPolicyContainer}>
          <Text style={styles.text}>
            By clicking, I accept the{' '}
            <Text style={styles.link} onPress={handleTermsClick}>terms of service</Text> and{' '}
            <Text style={styles.link} onPress={handlePrivacyClick}>privacy policy</Text>.
          </Text>
        </View>
      </View>
    </View>
